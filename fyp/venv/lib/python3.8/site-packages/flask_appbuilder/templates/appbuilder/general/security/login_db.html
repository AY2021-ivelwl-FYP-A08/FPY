        ...
        <div class="panel panel-primary" >
            <div style="padding-top:30px" class="panel-body-login" >
                ...
                <form class="form" action="" method="post" name="login">
                    {{form.hidden_tag()}}
                    <div class="help-block">{{_("User login")}}:</div>
                    <div class="control-group{% if form.errors.openid is defined %} error{% endif %}">
                        <label class="control-label-loginpage" for="openid">{{_("Username")}}:</label>
                        ...
                        <div class="controls">
                            ...
                            {% endfor %}
                            <label class="control-label-loginpage" for="openid">{{_("Password")}}:</label>
